...
public class UserUpdate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    out.print("  <h2 id='b2'>Update profile</h2>");
	    
	    out.println("<form action='UpdateController'>");
	    out.print("  <table>");
	    out.print(" <tr>");
	    out.print("    <td>User ID:</td>");
	    out.print("<td><input type='text' name='userid' value="+ub.getUserid() + "></td>");
	    out.print("  </tr>");
		
	    out.print(" <tr>");
	    out.print("    <td>User Name:</td>");
		out.print("   <td><input type='text' name='username' value="+ub.getUsername() + "></td>");
		out.print("  </tr>");
		out.print("  <tr>");
		out.print("      <td>Password:</td>");
		out.print("     <td><input type='text' name='password' value="+ub.getPassword() + "></td> ");  
		out.print("   </tr>");
		out.print("  <tr>");
		out.print("      <td>Name:</td>");
		out.print("     <td><input type='text' name='name' value="+ub.getName() + "></td>");
		out.print(" </tr>");
		out.print("   <tr>");
		out.print("  <td>Address:</td>");
		out.print(" <td><input type='text' name='address' value="+ub.getAddress() + "></td>");
		out.print("  </tr>");
		out.print("  <tr>");
		out.print("      <td>Mobile:</td>");
		out.print("     <td><input type='text' name='mobile' value="+ub.getMobile() + "></td>");
		out.print(" </tr>");
		out.print(" <tr>");
		out.print("   <td>Email ID:</td>");
		out.print("   <td><input type='text' name='email' value="+ub.getEmail() +"></td>");
		out.print(" </tr>");
