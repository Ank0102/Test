...
public class CashBookController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<title>CashBook</title>");
	    ...
	    out.print("  <h2 id='b2'>Cash Book</h2>");
	    ...
	    out.print("  <table cellspacing='0',border='3px solid black'>");
		 ArrayList<CashBookBean>cbb=cd.findAll();
		   ...
		   out.print(" <tr style='color:White'>");
			...
			String date2=request.getParameter("date2");
				...
				CashBookDAO cbd = new CashBookDAO();
		 		 ArrayList<CashBookBean>cbbb= cbd.findByDate(date1, date2);
		 		 	Double cashsum=0.00;
			   for(CashBookBean c:cbbb) {
